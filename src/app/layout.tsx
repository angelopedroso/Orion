...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className} bg-background-900 scrollbar scrollbar-track-background-900 scrollbar-thumb-background-800 scrollbar-thumb-rounded-md scrollbar-w-2 hover:scrollbar-thumb-background-700/60`}
      >
        <SessionCtxProvider>
